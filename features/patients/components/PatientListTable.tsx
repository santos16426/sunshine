            ...
            >
              ...
              <td className="px-4 lg:px-6 py-4 lg:py-6">
                <div className="space-y-0.5">
                  <p className="text-sm font-medium text-foreground truncate max-w-[140px] capitalize">
              ...
              <td className="px-4 lg:px-6 py-4 lg:py-6">
                <p className="text-sm text-muted-foreground truncate max-w-[160px] capitalize">
